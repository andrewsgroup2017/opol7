  ...
  <section class="container">
    <div class="columns">
      <div class="column is-8">
        ...
        <div v-for="(person, idx) in contacts" :key="idx" class="user-list" >
          <div class="columns">
            <div class="column is-8">
            ...
            <div class="column is-4 right">
              <router-link :to="{ name: 'view-contact', params: { person: person.slug }}" class="button is-primary">View Person</router-link>
            </div>
          </div>
        </div>
